...
@verbatim
 ...
 ===============================================================================  
    ...
    [..] In reception, data are received and then stored into an internal Rx buffer while 
         ...
         transmitted.
    [..] The read access of the SPI_DR register can be done using the SPI_ReceiveData8()
         function and returns the Rx buffered value. Whereas a write access to the SPI_DR 
         can be done using SPI_SendData8() function and stores the written data into 
         Tx buffer.
...
/**
  ...
  *       operation to SPI_DR register (SPI_ReceiveData8()) followed by a read 
