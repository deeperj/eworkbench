...
void RTC_GetDateTime(uint32_t RTC_Format, RTC_DateTimeTypeDef* RTC_DateTimeStruct)
{
	...
	RTC_DateTimeStruct->RTC_Year= Date.RTC_Year ;
	RTC_DateTimeStruct->RTC_Month = Date.RTC_Month ;
	RTC_DateTimeStruct->RTC_WeekDay = Date.RTC_WeekDay ;
	RTC_DateTimeStruct->RTC_Date = Date.RTC_Date ;
	
	RTC_DateTimeStruct->RTC_Hours = Time.RTC_Hours ;
	RTC_DateTimeStruct->RTC_Minutes = Time.RTC_Minutes ;
	RTC_DateTimeStruct->RTC_Seconds = Time.RTC_Seconds ;
	RTC_DateTimeStruct->RTC_H12  = Time.RTC_H12 ;
}
...
ErrorStatus RTC_SetDateTime(uint32_t RTC_Format, RTC_DateTimeTypeDef* RTC_DateTimeStruct)
{
	RTC_DateTypeDef Date ;
	RTC_TimeTypeDef Time;
	
	Date.RTC_Year = RTC_DateTimeStruct->RTC_Year ;
	Date.RTC_Month = RTC_DateTimeStruct->RTC_Month ;
	Date.RTC_WeekDay = RTC_DateTimeStruct->RTC_WeekDay ;
	Date.RTC_Date = RTC_DateTimeStruct->RTC_Date ;
	
	Time.RTC_Hours   = RTC_DateTimeStruct->RTC_Hours ;
	Time.RTC_Minutes   = RTC_DateTimeStruct->RTC_Minutes ;
	Time.RTC_Seconds   = RTC_DateTimeStruct->RTC_Seconds ;
	Time.RTC_H12   = RTC_DateTimeStruct->RTC_H12 ;
	
	if (( RTC_SetDate(RTC_Format,&Date) == ERROR ) || (RTC_SetTime(RTC_Format, &Time) == ERROR ))
	{
		return ERROR;
	}
