...
#if !defined (STM32L1XX_LD) && !defined (STM32L1XX_MD) && !defined (STM32L1XX_MDP) && !defined (STM32L1XX_HD)
...
#define OPAMP_OTR_AO1_OPT_OFFSET_TRIM_H      ((uint32_t)0x000003E0)
#define OPAMP_OTR_AO1_OPT_OFFSET_TRIM_L      ((uint32_t)0x0000001F)
