...
//volatile USB_StateType USB_INTERFACE_STATE = USB_ENABLED_HID ; //USB_DISABLED;
//volatile USB_StateType LAST_INTERFACE_STATE ;

//this is used to track nmsd activity for putting the system on standy if connected to pc as storage device
volatile uint32_t MSD_LAST_ACCESS;
