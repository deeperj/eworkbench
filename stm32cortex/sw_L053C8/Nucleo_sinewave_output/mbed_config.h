...
#define CLOCK_SOURCE                                       USE_PLL_HSE_EXTC|USE_PLL_HSI                                                   // set by target:DISCO_L053C8
#define LPTICKER_DELAY_TICKS                               4                                                                              // set by target:DISCO_L053C8
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                    1                                                                              // set by target:DISCO_L053C8
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                     0                                                                              // set by target:DISCO_L053C8
