...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainMessageTableWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustIgnored)
        ...
        self.showBitsTableWidget = QtWidgets.QTableWidget(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(2)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.showBitsTableWidget.sizePolicy().hasHeightForWidth())
        self.showBitsTableWidget.setSizePolicy(sizePolicy)
        self.showBitsTableWidget.setObjectName("showBitsTableWidget")
        self.showBitsTableWidget.setColumnCount(10)
        self.showBitsTableWidget.setRowCount(12)
        item = QtWidgets.QTableWidgetItem()
        ...
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(10, item)
        item = QtWidgets.QTableWidgetItem()
        self.showBitsTableWidget.setVerticalHeaderItem(11, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.showBitsTableWidget.setHorizontalHeaderItem(9, item)
        self.showBitsTableWidget.horizontalHeader().setVisible(True)
        self.showBitsTableWidget.horizontalHeader().setDefaultSectionSize(54)
        self.horizontalLayout_4.addWidget(self.showBitsTableWidget)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 321, 559))
        ...
        MainWindow.setTabOrder(self.portScanButton, self.portSelectorComboBox)
        MainWindow.setTabOrder(self.portSelectorComboBox, self.portConnectButton)
        MainWindow.setTabOrder(self.portConnectButton, self.portDisconnectButton)
        MainWindow.setTabOrder(self.portDisconnectButton, self.activeChannelComboBox)
        MainWindow.setTabOrder(self.activeChannelComboBox, self.playbackDelaySpinBox)
        MainWindow.setTabOrder(self.playbackDelaySpinBox, self.autoclearCheckBox)
        MainWindow.setTabOrder(self.autoclearCheckBox, self.showSendingTableCheckBox)
        MainWindow.setTabOrder(self.showSendingTableCheckBox, self.groupModeCheckBox)
        MainWindow.setTabOrder(self.groupModeCheckBox, self.hideControlsButton)
        MainWindow.setTabOrder(self.hideControlsButton, self.stopSniffingButton)
        MainWindow.setTabOrder(self.stopSniffingButton, self.startSniffingButton)
        MainWindow.setTabOrder(self.startSniffingButton, self.loadSessionFromFileButton)
        MainWindow.setTabOrder(self.loadSessionFromFileButton, self.abortSessionLoadingButton)
        MainWindow.setTabOrder(self.abortSessionLoadingButton, self.tabWidget)
        MainWindow.setTabOrder(self.tabWidget, self.mainMessageTableWidget)
        MainWindow.setTabOrder(self.mainMessageTableWidget, self.scrollArea_2)
        MainWindow.setTabOrder(self.scrollArea_2, self.clearTableButton)
        MainWindow.setTabOrder(self.clearTableButton, self.highlightNewIdCheckBox)
        MainWindow.setTabOrder(self.highlightNewIdCheckBox, self.highlightNewDataCheckBox)
        MainWindow.setTabOrder(self.highlightNewDataCheckBox, self.hideOldPacketsCheckBox)
        MainWindow.setTabOrder(self.hideOldPacketsCheckBox, self.hideOldPeriod)
        MainWindow.setTabOrder(self.hideOldPeriod, self.showOnlyIdsCheckBox)
        MainWindow.setTabOrder(self.showOnlyIdsCheckBox, self.showOnlyIdsLineEdit)
        MainWindow.setTabOrder(self.showOnlyIdsLineEdit, self.hideIdsCheckBox)
        MainWindow.setTabOrder(self.hideIdsCheckBox, self.hideIdsLineEdit)
        MainWindow.setTabOrder(self.hideIdsLineEdit, self.hideAllPacketsButton)
        MainWindow.setTabOrder(self.hideAllPacketsButton, self.saveSelectedIdInDictButton)
        MainWindow.setTabOrder(self.saveSelectedIdInDictButton, self.saveIdToDictLineEdit)
        MainWindow.setTabOrder(self.saveIdToDictLineEdit, self.saveLabelToDictLineEdit)
        MainWindow.setTabOrder(self.saveLabelToDictLineEdit, self.addToDecodedPushButton)
        MainWindow.setTabOrder(self.addToDecodedPushButton, self.saveSessionToFileButton)
        MainWindow.setTabOrder(self.saveSessionToFileButton, self.playbackMainTableButton)
        MainWindow.setTabOrder(self.playbackMainTableButton, self.stopPlayBackButton)
        MainWindow.setTabOrder(self.stopPlayBackButton, self.decodedMessagesTableWidget)
        MainWindow.setTabOrder(self.decodedMessagesTableWidget, self.deleteDecodedPacketLinePushButton)
        MainWindow.setTabOrder(self.deleteDecodedPacketLinePushButton, self.sendSelectedDecodedPacketButton)
        MainWindow.setTabOrder(self.sendSelectedDecodedPacketButton, self.idLabelDictTable)
        MainWindow.setTabOrder(self.idLabelDictTable, self.checkBox_6)
        MainWindow.setTabOrder(self.checkBox_6, self.clearLabelDictButton)
        MainWindow.setTabOrder(self.clearLabelDictButton, self.txTable)
        MainWindow.setTabOrder(self.txTable, self.newTxTableRow)
        MainWindow.setTabOrder(self.newTxTableRow, self.removeTxTableRow)
        MainWindow.setTabOrder(self.removeTxTableRow, self.sendTxTableButton)
        MainWindow.setTabOrder(self.sendTxTableButton, self.repeatedDelayCheckBox)
        MainWindow.setTabOrder(self.repeatedDelayCheckBox, self.repeatTxDelayValue)
        MainWindow.setTabOrder(self.repeatTxDelayValue, self.txDataRadioButton)
        MainWindow.setTabOrder(self.txDataRadioButton, self.snifferMsgPlainTextEdit)
        MainWindow.setTabOrder(self.snifferMsgPlainTextEdit, self.serialConnectedCheckBox)
        MainWindow.setTabOrder(self.serialConnectedCheckBox, self.rxDataRadioButton)
        MainWindow.setTabOrder(self.rxDataRadioButton, self.showControlsButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.showBitsTableWidget.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "PID"))
        item = self.showBitsTableWidget.verticalHeaderItem(1)
        item.setText(_translate("MainWindow", "RTR"))
        item = self.showBitsTableWidget.verticalHeaderItem(2)
        item.setText(_translate("MainWindow", "IDE"))
        item = self.showBitsTableWidget.verticalHeaderItem(3)
        item.setText(_translate("MainWindow", "DLC"))
        item = self.showBitsTableWidget.verticalHeaderItem(4)
        item.setText(_translate("MainWindow", "DATA0"))
        item = self.showBitsTableWidget.verticalHeaderItem(5)
        item.setText(_translate("MainWindow", "DATA1"))
        item = self.showBitsTableWidget.verticalHeaderItem(6)
        item.setText(_translate("MainWindow", "DATA2"))
        item = self.showBitsTableWidget.verticalHeaderItem(7)
        item.setText(_translate("MainWindow", "DATA3"))
        item = self.showBitsTableWidget.verticalHeaderItem(8)
        item.setText(_translate("MainWindow", "DATA4"))
        item = self.showBitsTableWidget.verticalHeaderItem(9)
        item.setText(_translate("MainWindow", "DATA5"))
        item = self.showBitsTableWidget.verticalHeaderItem(10)
        item.setText(_translate("MainWindow", "DATA6"))
        item = self.showBitsTableWidget.verticalHeaderItem(11)
        item.setText(_translate("MainWindow", "DATA7"))
        item = self.showBitsTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "HEX"))
        item = self.showBitsTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "DEC"))
        item = self.showBitsTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Bit 0"))
        item = self.showBitsTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Bit 1"))
        item = self.showBitsTableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Bit 2"))
        item = self.showBitsTableWidget.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Bit 3"))
        item = self.showBitsTableWidget.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Bit 4"))
        item = self.showBitsTableWidget.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "Bit 5"))
        item = self.showBitsTableWidget.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "Bit 6"))
        item = self.showBitsTableWidget.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "Bit 7"))
