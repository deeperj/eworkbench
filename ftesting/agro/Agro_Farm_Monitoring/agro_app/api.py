...
class FarmCertificateViewSet(viewsets.ModelViewSet):
    """ViewSet for the FarmCertificate class"""

    queryset = models.FarmCertificate.objects.all()
    serializer_class = serializers.FarmCertificateSerializer
    permission_classes = [permissions.IsAuthenticated]
...
class AssessmentViewSet(viewsets.ModelViewSet):
    """ViewSet for the Assessment class"""
